...
namespace HypoluxAdventure.Screens
{
    internal class MenuScreen : AbstractScreen
    {
        ...
        public override void LoadContent()
        {
            ...
            _play = new Button(Game, _menuFont, "JOUER", new Vector2(_textPositionCenter.X + 30, _textPositionCenter.Y), () => { Game.LoadWorld(1); });
            _quit = new Button(Game, _menuFont, "QUITTER", new Vector2(_textPositionCenter.X + 400, _textPositionCenter.Y), () => { Game.Exit(); });
            _settings = new Button(Game, _menuFont, "PARAMETRES", new Vector2(_textPositionCenter.X - 400, _textPositionCenter.Y), () => { Game.LoadSettings(0.5f); });
